...
Client c;
    ...
    player = new QMediaPlayer(this);
        ...
        animation = new QPropertyAnimation(ui->label_17,"geometry");
            ...
            animation->start();
            animation = new QPropertyAnimation(ui->label_22,"geometry");
                animation->setDuration(90000);
                animation->setStartValue(ui->label_22->geometry());
                animation->setEndValue(QRect(8000,80,20,0));
                animation->start();
                animation = new QPropertyAnimation(ui->label_24,"geometry");
                    animation->setDuration(90000);
                    animation->setStartValue(ui->label_24->geometry());
                    animation->setEndValue(QRect(8000,80,20,0));
                    animation->start();
                    animation = new QPropertyAnimation(ui->label_25,"geometry");
                        animation->setDuration(90000);
                        animation->setStartValue(ui->label_25->geometry());
                        animation->setEndValue(QRect(8000,80,20,0));
                        animation->start();
                        animation = new QPropertyAnimation(ui->label_29,"geometry");
                            animation->setDuration(90000);
                            animation->setStartValue(ui->label_29->geometry());
                            animation->setEndValue(QRect(8000,80,20,0));
                            animation->start();
    ...
    ui->tabWidget->setTabText(0,"Customer");
            ...
            ui->tabWidget_2->setTabText(0,"Add Customer");
             ...
             ui->label_id_2->setText( tr(" ID"));
                    ui->label_gpmusic->setText( tr("Name Group Music"));
